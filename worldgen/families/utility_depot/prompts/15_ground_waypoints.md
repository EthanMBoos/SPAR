...
sight, and returns only the scalar target-facing yaw. Make this inspection point the first of seven XYZ
route points. Choose the other six points along connected aisle centers through
both rack approaches and naturally back toward staging, with useful Husky
clearance and no redundant trip to the dock.
